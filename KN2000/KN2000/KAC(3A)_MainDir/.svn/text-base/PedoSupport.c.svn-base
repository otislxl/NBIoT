/* EasyCASE V6.5 13/01/2011 10:38:01 */
/* EasyCASE O
If=vertical
LevelNumbers=no
LineNumbers=no
...
* PedoSupport.c
*
* Usage: This File contains APIs to support the "Pedometer.c" file.
*                
*
* Author: Kamal.Joshi@in.bosch.com & Rajender.Singh@in.bosch.com
**************************************************************************************************/
/* EasyCASE ( 5
   Disclaimer */
/*************************************************************************************************/
...
/* EasyCASE ( 100012
   File Name For Doxy */
/*! \file PedoSupport.c
    \brief  This File contains APIs to support the Pedometer.c file. */
/* EasyCASE ) */
/* EasyCASE ( 247
   Includes */
/* EasyCASE ( 912
 ...
 *
 ******************************************************************************/
 void ProcessLPF(ts_LPF *p_ObjLPF)//µÍÍ¨ÂË²¨Æ÷
   {
   /* EasyCASE ( 101030
