/* EasyCASE V6.5 13/01/2011 10:27:43 */
/* EasyCASE O
If=vertical
LevelNumbers=no
LineNumbers=no
...
* PedoSupport.h
*
* Usage: This File is the header file for "PedoSupport.c" which contains APIs to support
* the Pedometer.c file.
*
*
* Author: Rajender.Singh@in.bosch.com & Brijesh.Singh@in.bosch.com 
**************************************************************************************************/
/* EasyCASE ( 72
   Disclaimer */
/*************************************************************************************************/
...
/* EasyCASE ( 913
   File Name For Doxy */
/*! \file PedoSupport.h
    \brief  This File is the header file for "PedoSupport.c" which contains APIs to support
     the Pedometer.c file. */
/* EasyCASE ) */
/* EasyCASE ( 73
   Includes */
