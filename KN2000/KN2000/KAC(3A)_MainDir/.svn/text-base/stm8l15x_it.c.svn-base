...
extern void Timer3ProgramHandle(void);
...
INTERRUPT_HANDLER(TIM2_UPD_OVF_TRG_BRK_USART2_TX_IRQHandler,19)
{
  ...
  ItStsFlag=TIM2_GetITStatus(TIM2_IT_Update);
  if (ItStsFlag)  
  {
...
INTERRUPT_HANDLER(TIM2_CC_USART2_RX_IRQHandler,20)
{
    ...
    */
	...
	UART2_ISR(USART_ReceiveData8(USART2));
}
...
INTERRUPT_HANDLER(TIM3_UPD_OVF_TRG_BRK_USART3_TX_IRQHandler,21)
{
    ...
    */
	...
	ItStsFlag=TIM3_GetITStatus(TIM3_IT_Update);
	if (ItStsFlag)  
	{
		Timer3ProgramHandle();
...
INTERRUPT_HANDLER(TIM3_CC_USART3_RX_IRQHandler,22)
{
  ...
  UART3_ISR(USART_ReceiveData8(USART3));
}
/**
...
INTERRUPT_HANDLER(USART1_RX_TIM5_CC_IRQHandler,28)
{
  ...
  UART1_ISR(USART_ReceiveData8(USART1));
}
