/* EasyCASE V6.5 20/06/2011 15:09:56 */
/* EasyCASE O
If=vertical
LevelNumbers=no
LineNumbers=no
...
* Pedometer.h
*
* Usage: This file is the header file for "Pedometer.c" to get the Steps( Delta, Last activity, Current Activity,
* Total), User Activity type, Cadence(Steps/sec), Distance( Delta, Last Activity, Currrent Activity, Total),
* Speed, Dyanamic Step Length etc.
* 
*                
*
...
/* EasyCASE ( 100012
   File Name For Doxy */
/*! \file Pedometer.h
    \brief  This file is the header file for "Pedometer.c" to get the Steps( Delta, Last activity, Current Activity, Total),
     User Activity type, Cadence(Steps/sec), Distance(Delta, Last Activity, Currrent Activity, Total), Speed, Dyanamic Step Length etc. */
/* EasyCASE ) */
/* EasyCASE ( 247
   Includes */
/* EasyCASE ( 912
...
{
	unsigned char startcnttime[13];
	unsigned char endcnttime[13];
